...
[fromCur, toCur].forEach((select, i) => {
    for (let curCode in Country_List) {
        const selected = (i === 0 && curCode === "PKR") || (i === 1 && curCode === "USD") ? "selected" : "";
...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://v6.exchangerate-api.com/v6/196249f3fed9fba052ed483e/latest/${fromCur.value}`);
